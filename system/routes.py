...
from system import app, db, bcrypt, mail, serial, photos, docs
from system.form import AppointmentForm, LoginForm, RegistrationForm, DoctorRegistration
from flask import flash, render_template, url_for, redirect, send_from_directory
...
from system.send_mails import (send_approval_email, send_confirmation_email,
                               ...
                               send_patient_cancellation_email)
